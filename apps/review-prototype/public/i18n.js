(function () {
  ...
  const englishText = {
    ...
    '当前是交互原型': 'Interactive prototype',
    '页面消息是演示数据，尚未连接真实聊天网络。': 'Messages on this page are demo data; it is not connected to the real chat network yet.',
    '个人首页': 'Personal home',
    ...
    '接下来要做': 'Next',
    '把协议内核接入真正的桌面客户端，在永久测试社区里验证邀请、聊天和服务器迁移。': 'Connect the protocol core to a real desktop client and test invites, chat, and server migration in a permanent test community.',
